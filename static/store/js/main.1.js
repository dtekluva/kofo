...
var evaluate_data_for_table = (()=>{
// console.log(useraccounts)
// console.log(useraccounts, users, transactions)
  useraccounts.forEach((element) => {
    console.log(element.fields.fname)
        let new_arr = [];
        new_arr.push(element.fields.fname + "  " + element.fields.lname ) 
        new_arr.push(element.fields.address) 
        new_arr.push(element.fields.fee) 
        new_arr.push(get_paid(element)) //change to amount paid from transactions
        new_arr.push(get_bal(element)) //resolve balance write function
        new_arr.push(get_excess(element)) //resolve Excess
...
var get_bal = ((user)=>{
  ...
  transactions.forEach((element)=>{
      if (element.fields.user == user.fields.user && _all_months.indexOf(current_month.toLowerCase()) >= _all_months.indexOf(element.fields.month)){
